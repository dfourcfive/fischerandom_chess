...
class FischerRandomConverters {
  static final FischerRandomConverters _instance = FischerRandomConverters._internal();
  FischerRandomConverters._internal();
  factory FischerRandomConverters() => _instance;
