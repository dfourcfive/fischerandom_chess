class FischerRandomValidators {
  static final FischerRandomValidators _instance = FischerRandomValidators._internal();
  FischerRandomValidators._internal();
  factory FischerRandomValidators() => _instance;
